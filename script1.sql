...
INSERT INTO SECTION_SKILL(SKILL_ID,SEC_ID)
VALUES(3,1),
(3,2),
(3,3),
(3,4);

INSERT INTO SCHEDULE(SCH_ID,SCH_DATE,EMP_ID)
VALUES(1,'2023-03-26',1),
(2,'2023-03-26',2),
(3,'2023-03-26',3),
(4,'2023-03-26',4),
(5,'2023-03-26',5),
...
INSERT INTO S_SHIFT(SHIFT_ID, SHIFT_START, SHIFT_END, SHIFT_TYPE, EMP_ID, SEC_ID, SCH_ID)
VALUES
(1, '2023-03-26 12:00:00', '2023-03-26 22:00:00', 'S', 1, 1, 1),
(2, '2023-03-26 12:00:00', '2023-03-26 22:00:00', 'S', 2, 2, 2),
(3, '2023-03-26 12:00:00', '2023-03-26 14:00:00', 'S', 3, 3, 3),
(4, '2023-03-26 12:00:00', '2023-03-26 23:00:00', 'S', 4, 3, 4),
(5, '2023-03-26 12:00:00', '2023-03-27 00:00:00', 'S', 5, 3, 5),
(6, '2023-03-26 17:00:00', '2023-03-26 17:00:15', 'B', 6, 4, 6),
(7, '2023-03-26 12:00:00', '2023-03-26 12:00:15', 'B', 7, 4, 7),
(8, '2023-03-26 12:00:00', '2023-03-26 23:00:00', 'S', 6, 4, 6),
(9, '2023-03-26 12:00:00', '2023-03-27 00:00:00', 'S', 7, 4, 7);

INSERT INTO INVENTORY(INV_ID,INV_TITLE,INV_PRICE,INV_QTY)
VALUES(1,'uniform',20.21,19),
(2,'chips', 0.50,1000),
(3,'card decks',5.00,300);


INSERT INTO SHIFT_INVENTORY(SHIFT_ID, INV_ID,QUANTITY, ASSIGN_DATE, ASSIGN_STATUS,EXP_DATE)
VALUES(1,1,10,'2023-03-26','FULFILLED',NULL),
(1,2,1000,'2023-03-26','FULFILLED',NULL),
(1,2,100,'2023-03-26','FULFILLED',NULL);
*/
